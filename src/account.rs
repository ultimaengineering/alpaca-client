...
pub struct Account {
    pub account_blocked: String, //If true, the account activity by user is prohibited.
    ...
    pub pattern_day_trader: String, //Whether or not the account has been flagged as a pattern day trader
    ...
    pub shorting_enabled: String, //Flag to denote whether or not the account is permitted to short
    ...
    pub trade_suspended_by_user: String, //User setting. If true, the account is not allowed to place orders.
    pub trading_blocked: String, //If true, the account is not allowed to place orders.
    pub transfers_blocked: String //If true, the account is not allowed to request money transfers.
}